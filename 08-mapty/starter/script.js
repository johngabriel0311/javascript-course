...
class Workout {
  ...
  constructor(coords, distance, duration) {
    this.coords = coords; // stores the coordinates as an array of lat and long
    this.distance = distance; // stores distance in km
    this.duration = duration; // stores duration in minutes
  }

  // Generate Workout Descriptiom
  _setDescription() {
    const months = [
      'January',
      'February',
...
class App {
  ...
  _moveToPopup(e) {
    ...
    // find the workout object using data id
  ...
  _loadDefaultMap() {
    console.log('Loading default map (Manila)');
  ...
  _loadMap(position) {
    ...
    // IMPORTANT PART
    // Create coordinates array for leaflet
  ...
  _toggleElevationField() {
    // Turn on input elevation
    inputElevation.closest('.form__row').classList.toggle('form__row--hidden');
    // Turn off input cadence
  ...
  _getLocalStorage() {
    ...
    // parse the data back to javascript objects
